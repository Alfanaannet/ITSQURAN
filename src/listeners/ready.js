...
class ReadyEvent extends Listener {
	...
	run() {
		...
		//Game
        const activities = [
        { name: `・❓┆/help`, type: "LISTENING" }, // LISTENING
        { name: `${client.channels.cache.size} Channels`, type: "PLAYING" }, // PLAYING
        { name: `${client.users.cache.size} Users`, type: "WATCHING" }, // WATCHING
        { name: `${client.guilds.cache.size} Servers`, type: "COMPETING" } // COMPETING
      ];
      const status = [
        'dnd',
        'idle'
